...
// chamara aqui a função da jogada da CPU
jogada_cpu();
...
function verifica_ganhador(){
    ...
    //c condilçoes de vitoria do cpu nas linhas
    ...
    if (linha2coluna1 == "X" && linha2coluna2 == "X" && linha3coluna3 =="X"){
        pontos_cpu++;
        mostrar_placar();
        retorno = true;
    }
    ...
    // condições de vitoria do cpu nas colunas
